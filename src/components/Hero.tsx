        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              asChild
              className="bg-gradient-hero hover:opacity-90 transition-opacity text-lg px-8 py-6 shadow-cookify-lg"
            >
          ...
          <p className="text-white/70 text-sm mt-6">
            7-day free trial • No credit card required • 4 recipes per day
          </p>
        </div>
      </div>
    </section>
